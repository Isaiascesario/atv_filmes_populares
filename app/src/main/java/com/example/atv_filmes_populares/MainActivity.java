...
import com.example.atv_filmes_populares.Movie;
import com.example.atv_filmes_populares.MovieAdapter;
import com.example.atv_filmes_populares.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void lidaComJSON (String jsonTextual){
        Gson gson = new Gson();
        movie = gson.fromJson(jsonTextual,Movie.class);
        movieList.add(movie);
